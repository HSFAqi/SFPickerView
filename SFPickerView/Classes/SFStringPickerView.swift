...
//        return SFBasePickerView.showPickerWithTitle(title, style: .label(appearance: appearance), dataSource: dataSource, defaultIndex: defaultIndex, config: config, callback: callback)
//    }
...
//        self.showPickerWithTitle(title, style: .label(appearance: appearance), dataSource: dataSource, defaultIndex: defaultIndex, config: config, callback: callback)
//    }
//    
//    // MARK: - 单列+多列+联动
//    /// 【String】单列+多列+联动，类方法
...
//        return SFBasePickerView.showPickerWithTitle(title, style: .label(appearance: appearance), mode: mode, defaultIndexs: defaultIndexs, config: config, callback: callback)
//    }
...
//        self.showPickerWithTitle(title, style: .label(appearance: appearance), mode: mode, defaultIndexs: defaultIndexs, config: config, callback: callback)
//    }
}
